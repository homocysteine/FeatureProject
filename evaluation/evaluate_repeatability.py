...
cache_dir = '/home/yushichen/PycharmProjects/pythonProject/data/cache_rep'
...
plt.ylabel('Detector repeatability', fontname='DejaVu Sans')
plt.ylim([0, 0.8])
plt.yticks([x/10 for x in range(9)], fontname='DejaVu Sans')
plt.grid(linestyle=':')
...
if top_k is None:
    plt.savefig('/home/yushichen/PycharmProjects/pythonProject/data/figs/hseq-mrep.pdf', bbox_inches='tight', dpi=300)
else:
    plt.savefig('/home/yushichen/PycharmProjects/pythonProject/data/figs/hseq-top-mrep.pdf', bbox_inches='tight', dpi=300)
...
plt.xlim(plt_lim)
plt.xticks(plt_rng, fontname='DejaVu Sans')
plt.ylabel('Repeated keypoints number', fontname='DejaVu Sans')
plt.ylim([0, 400])
plt.yticks([x*40 for x in range(11)], fontname='DejaVu Sans')
plt.grid(linestyle=':')
plt.tick_params(axis='both', which='major', labelsize=20)
plt.legend(prop=font1, loc='lower right')
...
if top_k is None:
    plt.savefig('/home/yushichen/PycharmProjects/pythonProject/data/figs/hseq-mrepn.pdf', bbox_inches='tight', dpi=300)
else:
    plt.savefig('/home/yushichen/PycharmProjects/pythonProject/data/figs/hseq-top-mrepn.pdf', bbox_inches='tight', dpi=300)
