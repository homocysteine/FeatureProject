...
# main workflow
cache_dir = '/home/yushichen/PycharmProjects/pythonProject/data/cache_mma'
...
plt.ylabel('Mean matching accuracy', fontname='DejaVu Sans')
plt.ylim([0, 1])
...
if top_k is None:
    plt.savefig('/home/yushichen/PycharmProjects/pythonProject/data/figs/hseq-mma.pdf', bbox_inches='tight', dpi=300)
else:
    plt.savefig('/home/yushichen/PycharmProjects/pythonProject/data/figs/hseq-top-mma.pdf', bbox_inches='tight', dpi=300)
...
plt.xlim(plt_lim)
plt.xticks(plt_rng, fontname='DejaVu Sans')
plt.ylabel('Matching keypoints number', fontname='DejaVu Sans')
plt.ylim([0, 300])
plt.yticks([x*30 for x in range(11)], fontname='DejaVu Sans')
plt.grid(linestyle=':')
plt.tick_params(axis='both', which='major', labelsize=20)
plt.legend(prop=font1, loc='lower right')
...
if top_k is None:
    plt.savefig('/home/yushichen/PycharmProjects/pythonProject/data/figs/hseq-mpn.pdf', bbox_inches='tight', dpi=300)
else:
    plt.savefig('/home/yushichen/PycharmProjects/pythonProject/data/figs/hseq-top-mpn.pdf', bbox_inches='tight', dpi=300)
